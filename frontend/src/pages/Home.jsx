      ...
      <div className="hero-card glass-card">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Upload a PDF or DOCX file and instantly retrieve structured data for
            contact details, skills, experience, education, and more.
          </p>
        ...
        <div className="hero-panel">
          <UploadResume onUpload={handleUpload} isLoading={isLoading} onError={setError} />
          {isLoading && <Loading />}
